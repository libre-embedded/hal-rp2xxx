...
#pragma once
#ifndef RP2XXX_STRUCTS_UART_H
#define RP2XXX_STRUCTS_UART_H
...
{
    /* Constant attributes. */
    static constexpr struct_id_t id = 1;      /*!< uart's identifier. */
     ...
     * 8-bit low-power divisor value. These bits are cleared to 0 at reset.
     */
    inline void set_UARTILPR(uint8_t value) volatile
    {
     ...
     * The integer baud rate divisor. These bits are cleared to 0 on reset.
     */
    inline void set_UARTIBRD(uint16_t value) volatile
    {
     ...
     */
    inline uint8_t get_UARTFBRD() volatile
    {
        return UARTFBRD & 0b111111u;
    }
     ...
     * The fractional baud rate divisor. These bits are cleared to 0 on reset.
     */
    inline void set_UARTFBRD(uint8_t value) volatile
    {
...
static_assert(ifgen_struct<uart>);

static volatile uart *const UART0_2040 = reinterpret_cast<uart *>(0x40034000);

static volatile uart *const UART1_2040 = reinterpret_cast<uart *>(0x40038000);

static volatile uart *const UART0_2350 = reinterpret_cast<uart *>(0x40070000);

static volatile uart *const UART1_2350 = reinterpret_cast<uart *>(0x40078000);

template <uint8_t instance>
inline volatile uart *uart_instance(void)
    requires(instance == 0)
{
    return UART0_2040;
}
